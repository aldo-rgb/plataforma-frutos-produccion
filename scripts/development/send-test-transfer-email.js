/**
 * Script para enviar correo de prueba de transferencia de ticket
 */
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding: 10px 0;">
                          ...
                          <div style="color: #ffffff; font-size: 18px; font-weight: 700; font-family: monospace; background: rgba(0,0,0,0.3); padding: 10px; border-radius: 8px; margin-top: 5px;">camposaldo5@gmail.com</div>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 10px 0;">
...
async function sendTestEmail() {
  if (!RESEND_API_KEY) {
    ...
    console.log('   Agrega RESEND_API_KEY en tu .env.local');
    return;
  }
  
  console.log('📧 Enviando correo de prueba de transferencia...');
  console.log('   Destino: camposaldo5@gmail.com');
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log('\n📬 Revisa tu bandeja de entrada en camposaldo5@gmail.com');
    } else {
      console.log('\n❌ Error enviando correo:', data);
    }
  } catch (error) {
    console.log('\n❌ Error:', error.message);
  }
