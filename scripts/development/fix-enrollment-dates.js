...
async function fixEnrollmentDates() {
  try {
    console.log('🔧 Corrigiendo fechas del enrollment...\n');
    ...
    // Obtener enrollment de User 2 (ID 6)
    ...
    console.log('   cycleStartDate:', vision.startDate);
    console.log('   cycleEndDate:', vision.endDate);
