...
export async function POST(req: NextRequest) {
  try {
    ...
    const perfilData = {
      ...
      staffBasicoInterest: body.staffBasicoInterest || false,
      staffAvanzadoInterest: body.staffAvanzadoInterest || false,
      staffLideratoInterest: body.staffLideratoInterest || false,
      staffServicioInterest: body.staffServicioInterest || false,
