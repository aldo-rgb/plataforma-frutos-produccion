...
export const metadata: Metadata = {
  title: 'Gestión de Strikes | Coordinador',
...
export default async function StrikeManagementPage() {
  ...
  // Solo permitir acceso a coordinadores
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="border-b border-slate-800 pb-6">
          ...
          <p className="text-slate-400 mt-2">
            Panel de coordinador para gestionar faltas y otorgar vidas extra a estudiantes
          </p>
        </div>
