...
export default function AltaUsuariosPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ nombre: '', email: '', password: '', telefono: '', rol: 'PARTICIPANTE' }); // Reset form
    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      {!currentUserRole ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Teléfono */}
          <div>
            <label className="block text-slate-400 mb-2 text-sm font-medium">Teléfono</label>
            <div className="relative">
              <svg className="absolute left-3 top-3 text-slate-500" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
