              ...
              <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-8 relative">
                ...
                <div className="text-center text-white">
                  ...
                  <div className="inline-block bg-white/20 backdrop-blur-sm rounded-xl px-6 py-3">
                    ...
                    <div className="text-sm text-white/80">MXN / Anual</div>
                  </div>
                </div>
              </div>
  ...
  if (showPaymentSuccessModal) {
    return (
      <div className="fixed inset-0 bg-black/95 backdrop-blur-xl flex items-center justify-center z-[80] p-4 animate-in fade-in duration-300">
        <div className="bg-gradient-to-br from-indigo-900/40 via-slate-900 to-slate-900 rounded-3xl max-w-md w-full shadow-2xl border border-indigo-500/20 overflow-hidden animate-in zoom-in-95 duration-300">
          {/* Decorative elements */}
          ...
          <div className="relative p-8 text-center">
            ...
            <p className="text-slate-300 mb-6 text-base leading-relaxed animate-in slide-in-from-bottom-4 duration-500 delay-300">
              Tu solicitud está ahora en <span className="text-indigo-400 font-semibold">revisión</span>. 
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-left text-sm text-slate-300">
                  ...
                  <ul className="space-y-1.5">
                    ...
                    <li className="flex items-center gap-2">
                      <span className="w-1.5 h-1.5 bg-green-400 rounded-full"></span>
                      <span>Recibirás notificación por email</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full px-6 py-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 hover:from-indigo-500 hover:via-purple-500 hover:to-indigo-500 text-white rounded-xl font-bold transition-all hover:scale-105 active:scale-95 shadow-lg hover:shadow-2xl hover:shadow-indigo-500/50 animate-in slide-in-from-bottom-4 duration-500 delay-500"
            >
              Continuar
            </button>
          </div>
