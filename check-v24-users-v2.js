...
async function main() {
  ...
  console.log('Con check-in V24: ' + checkIns.length);
  ...
  for (const user of users) {
    ...
    const checkIn = checkIns.find(c => c.usuarioId === user.id);
    ...
    console.log('  ✅ Check-in: ' + (checkIn ? 'SÍ' : 'NO'));
    console.log('');
  }
  
  console.log('=== USUARIOS SIN ENROLLMENT ===');
